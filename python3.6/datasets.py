...
MSP_title_words = ['cloud', 'virtual', 'virt', 'tel', 'tech', 'soft', 'server', 'host', 'data', 'network', 'soft'] #MSP
MS_title_words = ['data', 'tel', 'host', 'cyber', 'web', 'tech', 'internet', 'smart', 'soft'] #Managed Services
DA_title_words = ['digital', 'web', 'influence', 'soft', 'internet', 'social', 'smart', 'data', 'media', 'creat',
                  'tel', 'tech', 'seo', 'design', 'agency'] # Digital Agency
